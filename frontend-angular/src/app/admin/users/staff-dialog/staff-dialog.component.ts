...
export class StaffDialogComponent implements OnInit {
  ...
  constructor( private fb: FormBuilder,private dialogRef: MatDialogRef<StaffDialogComponent>,private webService:WebService, @Inject(MAT_DIALOG_DATA) data) { 
  ...
  save() {
    ...
    this.webService.addStaffMember(obj).subscribe((res)=>{
